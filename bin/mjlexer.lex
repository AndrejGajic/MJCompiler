...
"??"        { return new_symbol(sym.BINARYOR, yytext()); }
"^"			{ return new_symbol(sym.POWER, yytext()); }
"!" 		{ return new_symbol(sym.FACTORIEL, yytext()); }
"#"			{ return new_symbol(sym.ARRAYINCREMENT, yytext()); }
...
.			{ System.err.println("Lexical error (" + yytext() + ") at line " + (yyline + 1) + " and column " + (yycolumn + 1) + "!"); }
