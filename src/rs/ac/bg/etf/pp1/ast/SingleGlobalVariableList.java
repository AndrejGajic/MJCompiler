...
public class SingleGlobalVariableList extends GlobalVarList {

    private GlobalVarDecl GlobalVarDecl;

    public SingleGlobalVariableList (GlobalVarDecl GlobalVarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("SingleGlobalVariableList(\n");
